...
$get_customers_addresses = "select * from customers_address where customer_id = '$customer_id'";

$run_customers_addresses = mysqli_query($con,$get_customers_addresses);

$count = mysqli_num_rows($run_customers_addresses);

if($count == 0){
    echo "<script>window.open('insert_address.php','_self')</script>";
}
...
<input type="hidden" name="return" value="http://localhost:8080/ecom/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total_cart_price; ?>">

<?php }else{ ?>

<input type="hidden" name="return" value="http://localhost:8080/ecom/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total; ?>">

<?php } ?>

<input type="hidden" name="cancel_return" value="http://localhost:8080/ecom/checkout.php">
